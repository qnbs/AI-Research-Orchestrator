...
- **Adversarial agent-eval fixtures (ISSUE-P1-EVAL-001):** `check:agent-eval` now includes German support/stopwords/negation, same-unit numeric and dose drift, prompt-injection titles, and malformed JSON blocking so matcher 2.3.0 regressions fail the eval gate.
