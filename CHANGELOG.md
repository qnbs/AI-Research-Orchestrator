...
- **Audit docs (2026-09-03 late closeout):** Provisional handover for the residual-audit wave at live `main` `cee4f9c` (#310 SOP after #309). Open follow-up: #311 (capability/offline/scientometric/CMDK copy). Execution prompt: `docs/prompts/2026-09-03-late-cursor-grok-audit-perfection-master-prompt.md`. No `v0.4.3` cut.
