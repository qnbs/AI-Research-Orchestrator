...
- **Claim evidence matcher (post-merge `2.1.1`):** Negation conflict checks all overlapping token occurrences (not only the first), closing a second-occurrence negation gap found in post-merge review of PR #213.
