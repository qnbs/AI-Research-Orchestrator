...
- Broader i18n migration (#69) — HelpView Wave 8 + chrome/modal/CommandPalette + InputForm + ResearchView + ReportDisplay + Settings (General + AI/KB/Export/Data + confirm modals + toasts) landed; residual backlog: remaining non-Settings views if any (Authors/Journals hubs, agent debugger chrome).
