...
- **Theme visual QA (`NOW-P1-THEME-QA`):** PR template and `CONTRIBUTING.md` include a manual dark / light / matrix checklist for chrome and overlays. Contrast stays `pnpm run check:contrast`. No screenshot suite in CI.
