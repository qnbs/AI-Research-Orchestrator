...
- **Sourcery residuals (`NOW-P1-SOURCERY-RESIDUAL`):** Settings/KB sidebars share `STICKY_BELOW_CHROME_CLASS`. Orchestrator generate-phase cancel uses `LoadingIndicator`’s caller-labeled control; the standalone cancel stays for streaming after the indicator unmounts.
