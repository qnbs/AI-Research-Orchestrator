...
- **Audit docs truth (2026-09-02):** Live `main` after the 2026-09-01 wave is `660cf8c` (`v0.4.2` plus #285–#289 / #287). `docs/audits/2026-09-01-baseline.md` keeps Phase 0 pinned at `8a76bda` and adds a landed-after-Phase-0 addendum. ADR 0010 is **Deferred — 2026-09-02** (heuristic + Ollama remain the zero-cost paths; OpenRouter stays `openai` + custom base URL).
