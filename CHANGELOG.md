...
- **Audit docs truth (2026-09-02):** Live `main` after #290/#291 is `5c539ec`. Execution planning is `docs/prompts/2026-09-02-cursor-grok-audit-remediation-master-prompt.md`. Evidence record is `docs/audits/2026-09-02-baseline.md` (post-merge addendum) plus `docs/audits/2026-09-02-closeout.md`. The 2026-09-01 / 2026-08-02 prompts stay historical. ADR 0010 dated deferral, façade split, and remaining chart a11y **shipped in #290**. Heuristic + Ollama remain the zero-cost paths; OpenRouter stays `openai` + custom base URL. GitHub repository description no longer overclaims a swarm (`NOW-P1-REPO-DESCRIPTION` resolved).
