          ...
          <div className="pt-6 border-t border-border">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <input
                ...
                placeholder="+ Add tag"
                className="bg-transparent border border-border rounded-full py-0.5 px-3 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus:border-brand-accent text-text-primary w-24 focus:w-32 transition-all placeholder-text-secondary/50"
              />
            </div>
          </div>
