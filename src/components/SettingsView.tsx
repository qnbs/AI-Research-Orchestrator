...
const GeneralSettingsTab: React.FC<{
    ...
    const { installPromptEvent, setInstallPromptEvent, isPwaInstalled } = useUI();
    ...
    <div className="space-y-8">
        ...
        <SettingCard icon={<InstallIcon className="w-6 h-6 text-brand-accent"/>} title="Application" description="Manage the application's installation status and offline capabilities.">
             {isPwaInstalled ? (
                ...
                <div>
                    <button onClick={handleInstallClick} className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-brand-text-on-accent bg-brand-accent hover:bg-opacity-90">
