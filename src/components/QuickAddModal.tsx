        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-brand-accent hover:bg-opacity-90 disabled:opacity-50 flex items-center"
            >
              {isLoading ? (
                <>
                  <svg
