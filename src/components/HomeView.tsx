...
const ActionButton: React.FC<{
  ...
  <button
    onClick={onClick}
    className="text-left bg-surface p-6 rounded-lg border border-border shadow-lg hover:shadow-xl hover:border-brand-accent/50 hover:-translate-y-1 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-brand-accent focus:ring-offset-2 focus:ring-offset-background"
  >
...
const HomeView: React.FC<HomeViewProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto text-center py-8 animate-fadeIn">
      ...
      <p className="max-w-2xl mx-auto text-lg text-text-secondary mb-12">{t('home.welcome')}</p>
