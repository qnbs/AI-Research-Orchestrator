  ...
  return (
    <div className="border border-border rounded-lg bg-surface overflow-hidden">
      <button
        ...
        className="w-full flex justify-between items-center p-4 text-left text-lg font-semibold text-text-primary hover:bg-surface-hover focus-ring-aa focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors"
      >
