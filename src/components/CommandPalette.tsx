  ...
  const commands = useMemo<Command[]>(() => {
      ...
      commandList.push(
        {
          ...
          type: 'action',
          title: `Export ${selectedArticleCount} selected as PDF`,
          icon: <ExportIcon className="h-5 w-5" />,
          action: () => onExportSelection('pdf'),
        },
        {
          id: 'action-export-csv',
          type: 'action',
          title: `Export ${selectedArticleCount} selected as CSV`,
          icon: <ExportIcon className="h-5 w-5" />,
          action: () => onExportSelection('csv'),
        },
        {
          id: 'action-export-bib',
          type: 'action',
          title: `Export ${selectedArticleCount} selected as BibTeX`,
          icon: <ExportIcon className="h-5 w-5" />,
          action: () => onExportSelection('bib'),
        },
        {
          id: 'action-export-ris',
          type: 'action',
          title: `Export ${selectedArticleCount} selected as RIS`,
          icon: <ExportIcon className="h-5 w-5" />,
          action: () => onExportSelection('ris'),
        },
      );
    }
    ...
    commandList.push(
      ...
      },
      {
        ...
        keywords: 'quick analyze question',
      ...
      commandList.push(
        {
          ...
          keywords: 'library articles saved',
    ...
    commandList.push(
      {
        id: 'theme-light',
        type: 'theme',
        title: 'Switch to Neon-Light Theme',
      ...
      },
      {
        id: 'theme-dark',
        type: 'theme',
        title: 'Switch to Cyber-Dark Theme',
        keywords: 'dark mode',
      ...
      },
      {
        id: 'theme-matrix',
        type: 'theme',
        title: 'Switch to Matrix-Green Theme',
        keywords: 'matrix green hacker',
