...
const AboutSection: React.FC = () => (
  <div className="prose prose-sm prose-invert max-w-none text-text-secondary/90 leading-relaxed">
    ...
    <p>
      This application is a tool designed to accelerate the process of scientific literature review.
      It leverages generative AI to automate the tedious tasks of searching, filtering, and
      synthesizing information from the PubMed database.
    </p>
    <p>
    ...
    <ul>
      <li>
        <strong>Privacy First:</strong> All your data is stored locally in your browser. Nothing is
    ...
    <p>
      This tool is for informational and research assistance purposes only. It is not a substitute
      for professional medical or scientific advice. The AI can make mistakes; always verify
      information from the primary source articles.
    </p>
  </div>
);
...
const HelpView: React.FC<HelpViewProps> = ({ initialTab, onTabConsumed }) => {
    ...
    () => [
      {
        ...
        content: (
          <>
            <p>This app offers three distinct but interconnected paths for conducting research:</p>
            <ol>
              <li>
              ...
              <li>
                <strong>The Orchestrator:</strong> For comprehensive literature reviews on a broad
                topic. This is your starting point for building out a new area of your knowledge
                base by analyzing many articles at once.
              </li>
              <li>
                <strong>The Author Hub:</strong> For deep dives into the work of a specific
                researcher. It helps you understand their impact, collaborations, and the evolution
                of their research focus over time.
              </li>
            </ol>
          </>
        ),
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              The <strong>Orchestrator</strong> tab is where you conduct large-scale literature
              reviews. Here’s how to fill out the form effectively:
            </p>
            <ul>
              <li>
                <strong>Primary Research Topic:</strong> Be as specific as possible. Instead of{' '}
                <code>coffee</code>, try{' '}
                <code>the effects of caffeine on sleep quality in young adults</code>. This helps
                the AI agents focus their search.
              </li>
              <li>
                <strong>Publication Date:</strong> Choose a timeframe relevant to your topic.
              </li>
              <li>
                <strong>Article Types:</strong> Select the types of evidence you trust most.{' '}
                <strong>Systematic Reviews</strong> and <strong>Meta-Analyses</strong> provide
                high-quality summaries and are considered strong forms of evidence.
              </li>
              <li>
                <strong>Synthesis Focus:</strong> This tells the AI what angle to take when
                summarizing the findings. Are you interested in a general overview, or specifically
            ...
            <Note type="tip" title="Pro-Tip: Advanced Topics">
              <p>
                Use boolean operators (`AND`, `OR`, `NOT`) in your topic for more precise control,
                e.g.,{' '}
                <code>
                  (intermittent fasting OR time-restricted eating) AND cognitive function NOT
                  Alzheimer
                </code>
                .
              </p>
          ...
          <>
            ...
            <ol>
              ...
              <li>
                ...
                potential authors with similar names. It presents you with distinct profiles based
                on co-authors, affiliations, and research topics. Select the correct one to proceed.
              </li>
              <li>
                <strong>View Profile:</strong> Once confirmed, the app generates a complete profile,
                including an AI-written career summary, key research concepts, estimated metrics,
                and an interactive publication timeline.
              </li>
            </ol>
            <Note type="info" title="What is Author Disambiguation?">
              This is a crucial step to ensure you are analyzing the correct person. Many
              researchers share common names. The AI groups publications into clusters that likely
              belong to a single individual to prevent mixing up their work.
            </Note>
          </>
        ),
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Saved reports contribute their articles to your personal{' '}
              <strong>Knowledge Base</strong>. This view consolidates all unique articles from all
              your reports into a single, powerful interface.
            </p>
            <ul>
              <li>
                <strong>Search & Filter:</strong> Use the extensive options on the left to narrow
                down hundreds of articles. You can filter by keywords from the text, report topics,
                your own custom tags, or show only open-access articles.
              </li>
              <li>
                <strong>Manage Articles:</strong> Select one or more articles via the checkboxes to
                perform bulk actions, such as deleting them or exporting citation data for your
                reference manager.
              </li>
              <li>
            ...
            <Note type="info" title="What does 'Unique Articles' mean?">
              The Knowledge Base automatically de-duplicates articles. If two different reports find
              the same article (based on its PMID), it will only appear once in your Knowledge Base.
              The version with the highest relevance score is retained by default.
            </Note>
          </>
        ),
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              You can export data from several places in the app, with all options configurable in
              the <code>Settings → Export</code> tab.
            </p>
            <ul>
              <li>
                <strong>From a Report:</strong> Export a single report as a PDF, its article data as
                a CSV, or just the AI Insights as a CSV.
              </li>
              <li>
                <strong>From the Knowledge Base:</strong> Select articles and export them as a
                summary PDF, a data-rich CSV, or a citation file.
                <ul>
                  <li>
                    <strong>PDF:</strong> Creates a clean, summary report of the selected articles.
                    Ideal for sharing.
                  </li>
                  <li>
                    <strong>CSV:</strong> Exports the raw data for spreadsheets or other analysis
                    tools.
                  </li>
                  <li>
                    <strong>Citations:</strong> Get files in <strong>BibTeX (.bib)</strong> or{' '}
                    <strong>RIS (.ris)</strong> format for reference managers like Zotero, Mendeley,
                    or EndNote.
                  </li>
                </ul>
              </li>
      ...
      },
      {
        ...
        content: (
          <>
            <p>Several features are available throughout the app to enhance your workflow.</p>
            <ul>
              <li>
                <strong>Command Palette:</strong> Press <Kbd>⌘ + K</Kbd> (or <Kbd>Ctrl + K</Kbd> on
                Windows) to open a powerful search bar. From here, you can instantly navigate to any
  ...
  const faqItems = useMemo(
    () => [
        ...
        content: (
          <>
            ...
            <p>
              ...
              This application is a tool to accelerate research, not a substitute for scholarly
      ...
      {
        title: 'How does the app access PubMed?',
        content: (
          <>
            <p>
              The application interacts directly with the public NCBI E-utilities API to search for
              and retrieve article data from PubMed. It acts as a client, sending requests from your
              browser to the NCBI servers. No intermediary server is involved.
            </p>
          </>
        ),
      },
      {
        title: 'Will this cost me money to use?',
        content: (
          <>
            <p>
            ...
            <p>
              You are responsible for monitoring your own API usage and any associated costs. You
              can do this in your Google AI Studio or Google Cloud Platform console.
            </p>
          </>
        ),
      },
      {
        title: "Why isn't an article I know exists showing up?",
        content: (
          <>
          ...
          <>
            ...
            <div className="mt-4 space-y-3 not-prose">
              <div className="grid grid-cols-[auto,1fr] items-center gap-x-4 gap-y-2">
                <Kbd>⌘ + K</Kbd>
                <span className="ml-4">Open Command Palette</span>
                <Kbd>⌘ + Enter</Kbd>
                <span className="ml-4">Submit Research Form</span>
                <Kbd>Esc</Kbd>
                <span className="ml-4">Close modal / panel / palette</span>
              </div>
            </div>
          </>
        ),
  ...
  const glossaryItems = useMemo(
    () => [
      ...
      },
      {
        ...
        content: (
          <p>
            The process by which the AI distinguishes between different researchers who may share
            the same name. It does this by analyzing co-authors, institutional affiliations, and
            publication topics to group articles into distinct profiles.
          </p>
        ),
      },
      {
        ...
        content: (
          <p>
            Standard file formats for bibliographic citations. Files with `.bib` (BibTeX) or `.ris`
            extensions can be imported into most reference management software like Zotero,
            Mendeley, or EndNote.
          </p>
        ),
      },
      {
        ...
        content: (
          <p>
            The central library within the app that stores all unique articles from all of your
            saved reports. It provides a de-duplicated, searchable, and filterable view of your
    ...
    () => [
      {
        ...
        name: 'User Guide',
        icon: BookOpenIcon,
        component: <GuideSection items={filteredGuideTopics} searchTerm={searchTerm} />,
      },
      {
        id: 'faq',
        name: 'FAQ & Shortcuts',
        icon: QuestionMarkCircleIcon,
        component: <FAQSection items={filteredFaqItems} searchTerm={searchTerm} />,
      },
      {
        id: 'glossary',
        name: 'Glossary',
        icon: BookmarkIcon,
        component: <GlossarySection items={filteredGlossaryItems} searchTerm={searchTerm} />,
      },
    ...
    <div className="max-w-4xl mx-auto animate-fadeIn">
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-lg text-text-secondary">
          Find answers and learn how to get the most out of the application.
        </p>
      </div>
