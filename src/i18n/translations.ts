...
export const translations = {
  en: {
    ...
    'onboarding.privacy':
      'Research data stays in your browser. Live mode still sends prompts to your chosen AI provider and queries to PubMed/arXiv.',
  ...
  de: {
    ...
    'onboarding.privacy':
      'Recherche-Daten bleiben im Browser. Im Live-Modus gehen Prompts an Ihren KI-Anbieter und Suchanfragen an PubMed/arXiv.',
