export const translations = {
  en: {
    ...
    'apikey.security.text_start': 'Your Gemini API key is',
    'apikey.security.encrypted': 'encrypted',
    'apikey.security.text_end':
      'and stored in this browser only. It is never sent to our servers. Requests go directly from your browser to the Google Gemini API.',
    'apikey.security.recommendation_label': 'Recommendation:',
    'apikey.security.recommendation_text': 'Restrict the key in the',
    'apikey.security.console_link': 'Google AI Studio Console',
    ...
    'apikey.status.prompt_link': 'Gemini API key',
    'apikey.status.prompt_end': 'to enable AI research features.',
    'apikey.reveal': 'Reveal',
    'apikey.label.update': 'Update Gemini API key',
    'apikey.label.enter': 'Enter Gemini API key',
    ...
    'apikey.ncbi.desc':
      'Improves PubMed/NCBI rate limits. Stored encrypted in the same browser vault pattern as the Gemini key, never in general app settings. Get a key at',
    ...
    'apikey.instructions.step1_link': 'Google AI Studio',
  ...
  de: {
    ...
    'apikey.invalid':
      'Ungültiges API-Schlüssel-Format. Gemini-API-Schlüssel beginnen mit "AIza" und sind 39 Zeichen lang.',
    ...
    'apikey.security.text_start': 'Ihr Gemini-API-Schlüssel ist',
    'apikey.security.encrypted': 'verschlüsselt',
    'apikey.security.text_end':
      'und wird nur in diesem Browser gespeichert. Er wird niemals an unsere Server gesendet. Anfragen gehen direkt von Ihrem Browser an die Google-Gemini-API.',
    ...
    'apikey.status.configured': 'Gemini-API-Schlüssel konfiguriert',
    'apikey.status.ready': 'Ihr Schlüssel ist sicher gespeichert und bereit für KI-Funktionen.',
    'apikey.status.not_configured': 'Kein Gemini-API-Schlüssel konfiguriert',
    'apikey.status.prompt_start': 'Geben Sie Ihren',
    'apikey.status.prompt_link': 'Gemini-API-Schlüssel',
    'apikey.status.prompt_end': 'ein, um KI-Recherchefunktionen zu aktivieren.',
    'apikey.reveal': 'Anzeigen',
    'apikey.label.update': 'Gemini-API-Schlüssel aktualisieren',
    'apikey.label.enter': 'Gemini-API-Schlüssel eingeben',
    ...
    'apikey.ncbi.desc':
      'Verbessert PubMed/NCBI-Ratenlimits. Wird verschlüsselt im selben Browser-Tresor wie der Gemini-Schlüssel gespeichert, niemals in den allgemeinen App-Einstellungen. Schlüssel erhältlich unter',
    ...
    'apikey.instructions.title': 'So erhalten Sie einen Gemini-API-Schlüssel:',
    'apikey.instructions.step1': 'Öffnen Sie',
    'apikey.instructions.step1_link': 'Google AI Studio',
    'apikey.instructions.step2': 'Melden Sie sich mit Ihrem Google-Konto an',
    'apikey.instructions.step3': 'Wählen Sie "Get API key" → "Create API key"',
    ...
    'journals.phase.disambiguate.d2': 'Abgleich mit kuratierem Journalwissen...',
