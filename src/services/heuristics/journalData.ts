/**
 * Curated journal knowledge base data.
 * Extracted from journalProfiling.ts to keep the main file under the 700-line limit.
 */

export interface JournalKbEntry {
  issn: string;
  description: string;
  oaPolicy: string;
  focusAreas: string[];
...
export const JOURNAL_KB: Record<string, JournalKbEntry> = {
  nature: {
    issn: '0028-0836',
    description:
  ...
  'cell reports': {
    issn: '2211-1247',
    description: 'Open-access journal from Cell Press covering the entire life-sciences spectrum.',
    oaPolicy: 'Full Open Access',
  ...
  bioinformatics: {
    issn: '1367-4803',
    description:
      'Core journal for computational biology, algorithms, and biological data analysis.',
    oaPolicy: 'Hybrid',
  ...
  'bmc bioinformatics': {
    issn: '1471-2105',
    description:
      'Open-access journal covering computational methods for biological and biomedical data.',
    oaPolicy: 'Full Open Access',
...
export const FIELD_JOURNALS: Record<string, { name: string; description: string }[]> = {
  cancer: [
    {
      name: 'CA: A Cancer Journal for Clinicians',
      description:
        'Highest-impact clinical oncology journal with flagship cancer statistics reports.',
    },
    {
      name: 'The Lancet Oncology',
      description:
        'Leading clinical oncology journal for trials and translational cancer research.',
    },
    {
  ...
  genetics: [
    ...
    },
    {
      ...
      description: 'Flagship human genetics journal with clinical and population studies.',
    },
  ],
  cardiology: [
    {
    ...
    },
    {
      ...
      description: 'JACC flagship journal for clinical cardiology and trials.',
    },
  ],
  cardiovascular: [
    {
  ...
  epidemiology: [
    ...
    },
    {
      ...
      description: 'Leading journal for epidemiological methods and population studies.',
    },
    {
      name: 'Epidemiology',
      description: 'Seminal journal for clinical and social epidemiology.',
    },
  ],
  psychiatry: [
    {
      name: 'The Lancet Psychiatry',
      description: 'Leading clinical psychiatry journal for trials and translational research.',
    },
    {
      name: 'JAMA Psychiatry',
      description: 'JAMA specialty journal for psychiatric research and clinical practice.',
    },
    {
      name: 'Molecular Psychiatry',
      description: 'High-impact journal for neurobiology and psychiatric genetics.',
    },
  ],
  psychology: [
    {
      name: 'Psychological Science',
      description: 'Leading general psychology journal for empirical research.',
    },
    {
      name: 'Journal of Experimental Psychology',
      description: 'APA flagship journal for experimental psychology.',
    },
  ],
  'machine learning': [
    {
      name: 'Nature Machine Intelligence',
      description: 'Springer Nature journal for machine-learning theory and applications.',
    },
    {
      name: 'Journal of Machine Learning Research',
      description: 'Leading open-access journal for ML theory and algorithms.',
    },
    {
      name: 'IEEE Transactions on Pattern Analysis and Machine Intelligence',
      description: 'Top-tier journal for computer vision and pattern recognition.',
    },
  ],
  ai: [
    {
