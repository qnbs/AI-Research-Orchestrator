...
export const Welcome: React.FC = () => {
  return (
    <div className="text-center text-dark-text-secondary p-8 flex flex-col items-center justify-center h-full animate-fadeIn">
      <DocumentIcon className="h-24 w-24 text-dark-border mb-6"/>
      <h2 className="text-3xl font-bold text-dark-text-primary mb-3">Welcome to the AI Research Orchestrator</h2>
      ...
      <div className="bg-dark-bg/50 border border-dark-border rounded-lg p-6 max-w-lg w-full">
          <h3 className="text-lg font-semibold text-dark-text-primary mb-4">How It Works</h3>
