...
| [0021](0021-partial-report-completion-state.md)         | Partial Report Completion State                         | Accepted | 2026-08-06 | New `ReportStatus.partial` + `completionStatus` marker; cancelled reports never look done     |
