...
**Still real (see 2026-09-01 baseline):** `NOW-P1-DEP-WAVE-2`, `NOW-P1-LIVE-COPY`, P2 façade/file-cap/OpenRouter/chart-a11y/lucide. `NOW-P0-PARTIAL-E2E` and `NOW-P1-PARTIAL-EXPORT-GAPS` close in the partial-report PR.
